        ...
        ScrollView {
            VStack(spacing: 15){
                ...
                Group {
                    ...
                    Group {
                        Button(action: {
                            let latestResult = modelsTP(trianglelength: trianglelength,
                                                        height: height,
                                                        oneSideOfTriangle: oneSideOfTriangle,
                                                        anotherSideOfTriangle:
                                                            anotherSideOfTriangle,
                                                        baseArea: baseArea, rectangleArea: rectangleArea, totalArea: totalArea, volume: volume, baseline: baseline
                            )
